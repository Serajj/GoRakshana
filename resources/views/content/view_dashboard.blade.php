    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            <h3 class="card-title font-weight-bolder text-white">Welcome to GoRakshana</h3>
                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6"><b>{{$upcoming_event_count}}</b> Upcoming Events </a>
                                    </div>
                                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2"><b>{{$count_user}}</b> Events</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                ...
                <!-- put extra c0pied in copy.blade.php -->
            </div>
        </div>
        <!--end::Container-->
    </div>

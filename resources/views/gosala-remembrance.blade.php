...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 card-container">
            <div class="card">
                <div class="card-header">{{ __('Request for event : ') }} {{ __('Remembrance day') }}</div>

                <div class="card-body happy">
                    <form method="POST" action="{{ route('gosala.addevent') }}">
                        @csrf
                        <input type="text" name="user_id" value="{{ auth()->user()->id }}" hidden>
                        <input type="text" name="event_type" value="remembrance" hidden>
                        ...
                        <div class="form-group row">
                            <label for="paksham" class="col-md-4 col-form-label text-md-right">{{ __('Paksham') }}</label>

                            <div class="col-md-6">
                                <input id="paksham" type="text" class="form-control @error('paksham') is-invalid @enderror" name="star" value="{{ old('paksham') }}" required autocomplete="paksham" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="thidi" class="col-md-4 col-form-label text-md-right">{{ __('Thidi') }}</label>

                            <div class="col-md-6">
                                <input id="thidi" type="text" class="form-control @error('thidi') is-invalid @enderror" name="thidi" value="{{ old('thidi') }}" required autocomplete="thidi" autofocus>
